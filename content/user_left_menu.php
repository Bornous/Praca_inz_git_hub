<div class="left_menu">		
	<form action="#" method="POST">
		...
		<div class="menu_option" onclick="javascript:this.parentNode.submit();">Zadania</div>
	</form>
	<form action="#"  method="POST">
		<input type="hidden" name="action_name" value="ranking_page">
		<div class="menu_option" onclick="javascript:this.parentNode.submit();">Ranking</div>
	</form>
	<form action="#"  method="POST">
